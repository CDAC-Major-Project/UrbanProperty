...
const PropertyVerification = () => {
  ...
  const propertyVerificationData = [
  {
    ...
    description: "Spacious office space located in the city center, ideal for startups and businesses.",
    address: "45 MG Road",
    city: "Pune",
    state: "Maharashtra",
    prize: 8500000,
  ...
  },
  {
    ...
    description: "Fully furnished apartment with modern amenities and parking space.",
  ...
  },
  {
    ...
    description: "Large-scale industrial unit suitable for textile production with ample power supply.",
  ...
  },
  {
    ...
    description: "Fully equipped restaurant space with kitchen and seating area.",
  ...
  },
  {
    ...
    description: "Fully furnished IT office with high-speed internet and meeting rooms.",
    address: "Cyber Hub",
    city: "Gurgaon",
    state: "Haryana",
    prize: 18000000,
  ...
  },
  {
    ...
    description: "Well-equipped fabrication plant with machinery and staff quarters.",
  ...
  },
  {
    ...
    description: "Shared coworking office with modern interiors and conference rooms.",
